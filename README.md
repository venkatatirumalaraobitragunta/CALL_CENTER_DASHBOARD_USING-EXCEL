✅ **Project Title:** Call Centre Performance Analysis Dashboard using Excel
...
The dataset includes important fields such as:
...
* Renaming and formatting column headers
* Converting dates and numbers into proper data types
...
Excel PivotTables, PivotCharts, and Slicers were used to display:
...
This project demonstrates how raw call centre data can be transformed into a clear and interactive dashboard using Excel. It showcases essential skills in data cleaning, chart creation, pivot analysis, and dashboard design, providing a practical overview of call centre performance without the need for advanced tools or formulas.
